...
public class FuzzySet {
	...
	public List<AnnualRecord> ar = new ArrayList<AnnualRecord>();
	public int chromosome[] ;
	public HashMap<String, String> arMap = new HashMap<String, String>();
	public HashMap<String, Integer> discourseMap = new HashMap<String, Integer>();
	private int order;
...
/*		AnnualRecord ar1 = new AnnualRecord("1971", 1025);
	...
	public void initializeFuzzySet() {
	...
	public void initializeFLRG(int order) {
	...
	public void initializeDiscourseMap() {
